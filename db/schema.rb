...
ActiveRecord::Schema.define(version: 20180120231141) do
  ...
  add_index "class_registrations", ["client_id"], name: "index_class_registrations_on_client_id", using: :btree
  add_index "class_registrations", ["subscription_id"], name: "index_class_registrations_on_subscription_id", using: :btree
  ...
  add_foreign_key "class_registrations", "clients"
  add_foreign_key "class_registrations", "subscriptions"
