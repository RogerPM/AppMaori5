...
class SaleDetailsControllerTest < ActionController::TestCase
  ...
  test "should create sale_detail" do
    assert_difference('SaleDetail.count') do
      post :create, sale_detail: { precio: @sale_detail.precio, product_id: @sale_detail.product_id, quantity: @sale_detail.quantity, sale_id: @sale_detail.sale_id, subtotal: @sale_detail.subtotal }
    end
  ...
  test "should update sale_detail" do
    patch :update, id: @sale_detail, sale_detail: { precio: @sale_detail.precio, product_id: @sale_detail.product_id, quantity: @sale_detail.quantity, sale_id: @sale_detail.sale_id, subtotal: @sale_detail.subtotal }
    assert_redirected_to sale_detail_path(assigns(:sale_detail))
  end
